...
class OrdersDisplay extends StatelessWidget {
  ...
  OrdersDisplay({required this.specOrders});
  @override
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            width: specOrders[i].items!.length >= 3
                                ? 120
                                : (specOrders[i].items!.length * 40).toDouble(),
                            child: GridView.builder(
                              ...
                              itemBuilder: (context, x) => CachedNetworkImage(
                                height: 35,
                                width: 35,
                                ...
                                imageUrl: specOrders[i].items![x]['imgUrl'],
                          ...
                          Row(
                            children: [
                              ...
                              GetBuilder<CartViewModel>(
                                builder: (cartController) => RatingBar.builder(
